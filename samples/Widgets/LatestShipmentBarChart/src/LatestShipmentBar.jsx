...
class LatestShipmentBar extends Component {
    ...
    constructor(props) {
        ...
        const self = this;
        const ws = new WebSocket('ws://localhost:8080/data-provider/rdbms');
...
global.dashboard.registerWidget("LatestShipmentBar", LatestShipmentBar);
